...
* The title of the pull request must contain a special semver tag: `[semver:minor]`. ex: `[semver:minor] Added support for windows`

* 'minor' can be replaced with one of those options if needed:
